...
Aceasta este o aplicație desktop pentru monitorizarea bursei de valori (BVB) din România. Ea extrage și afișează preturile intraday și grafice tip „sparkline” pentru cele mai tranzacționate acțiuni plus informații despre principalii indici bursieri (inclusiv evidențierea companiilor din componența indicelui BET).
...
- **Tooltip**: Graficele din tabel și fereastra de detalii oferă informații precise prin tooltips care urmăresc cursorul mouse-ului.
- **Grafic Detaliat**: Click pe graficul unui simbol pentru a deschide o fereastră mare cu evoluția pretului intraday completă, crosshair și detalii exacte.
...
- **Istoric pret Intraday**: Salvează automat istoricul prețurilor pentru ziua curentă în fișiere JSON, permițând refacerea graficelor la repornire.
